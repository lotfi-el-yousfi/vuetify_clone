<template>
  <usage-example v-model="model" :code="code" :name="name" :options="options">
    <div
      class="py-8"
      :class="[!border && (isDark ? 'bg-grey-darken-3' : 'bg-grey-lighten-3')]"
    >
      <v-sheet v-if="sheet" v-model="sheet" v-bind="props" class="mx-auto">
      ...
      <div class="text-center">
        <v-btn v-if="!sheet" @click="sheet = true"> Show sheet </v-btn>
      </div>
    </div>
